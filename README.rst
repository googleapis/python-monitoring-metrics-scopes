Python Client for Metrics Scopes API API
========================================
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-monitoring-metrics-scopes.svg
   :target: https://pypi.org/project/google-cloud-monitoring-metrics-scopes/
.. _Metrics Scopes API API: https://cloud.google.com/monitoring/docs
...
3. `Enable the Metrics Scopes API API.`_
4. `Setup Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Metrics Scopes API API.:  https://cloud.google.com/monitoring/docs
...
-  Read the `Client Library Documentation`_ for Metrics Scopes API API
   to see other available methods on the client.
-  Read the `Metrics Scopes API API Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Metrics Scopes API API Product documentation:  https://cloud.google.com/monitoring/docs
