...
class MetricsScopesClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[MetricsScopesTransport]:
...
class MetricsScopesClient(metaclass=MetricsScopesClientMeta):
    ...
    def metrics_scope_path(metrics_scope: str,) -> str:
        ...
        return "locations/global/metricsScope/{metrics_scope}".format(
    ...
    def monitored_project_path(metrics_scope: str, project: str,) -> str:
        ...
        return "locations/global/metricsScopes/{metrics_scope}/projects/{project}".format(
    ...
    def parse_monitored_project_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^locations/global/metricsScopes/(?P<metrics_scope>.+?)/projects/(?P<project>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def list_metrics_scopes_by_monitored_project(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_metrics_scopes_by_monitored_project
        ]
